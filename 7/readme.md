The program uses select() to build a one-server-multi-client network. Select() forms a set of requests of clients, and the server handle these requests one by one.
